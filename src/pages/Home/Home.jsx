  ...
  useEffect(() => {
    ...
    expenseList.forEach((item) => {
      if (item.category == "food") {
        ...
        shoppingSpends += Number(item.price);
        shoppingCount++;
      } else if (item.category == "groceries") {
        grocerySpends += Number(item.price);
        groceryCount++;
    ...
    setCategorySpends({
      ...
      shopping: shoppingSpends,
      groceries: grocerySpends,
      others: otherSpends,
    });
      ...
      <div className={styles.cardsWrapper}>
        ...
        <PieChart
          data={[
            ...
            { name: "Shopping", value: categorySpends.shopping },
            { name: "Groceries", value: categorySpends.groceries },
            { name: "Others", value: categorySpends.others },
          ]}
        />
      </div>
      ...
      <div className={styles.transactionsWrapper}>
        ...
        <BarChart
          data={[
            ...
            { name: "Shopping", value: categoryCount.shopping },
            { name: "Groceries", value: categoryCount.groceries },
            { name: "Others", value: categoryCount.others },
          ]}
        />
      </div>
